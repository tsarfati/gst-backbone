...
DROP TABLE IF EXISTS public.qr_card_customization CASCADE;

-- Create table for QR card customization settings
CREATE TABLE public.qr_card_customization (
...
CREATE POLICY "Users can view their company QR customization"
...
CREATE POLICY "Users can insert their company QR customization"
ON public.qr_card_customization
FOR INSERT
WITH CHECK (
  company_id IN (
...
CREATE POLICY "Users can update their company QR customization"
ON public.qr_card_customization
FOR UPDATE
USING (
  company_id IN (
