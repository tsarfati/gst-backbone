...
const PERMISSION_CATEGORIES: PermissionCategory[] = [
  {
    ...
    permissions: [
      ...
      { key: 'jobs.view_tabs', label: 'View Job Tabs', description: 'Can access job tabs and subpages' },
      ...
      { key: 'jobs.read_only', label: 'Read-Only Jobs', description: 'Can view jobs but cannot modify job data' },
      ...
      { key: 'jobs.tabs.details.view', label: 'Job Details Tab (View)', description: 'Can view the Job Details tab' },
      { key: 'jobs.tabs.details.edit', label: 'Job Details Tab (Edit)', description: 'Can edit content on the Job Details tab' },
      { key: 'jobs.tabs.committed_costs.view', label: 'Committed Costs Tab (View)', description: 'Can view committed costs tab' },
      { key: 'jobs.tabs.committed_costs.edit', label: 'Committed Costs Tab (Edit)', description: 'Can create/update committed costs' },
      { key: 'jobs.tabs.cost_codes_budget.view', label: 'Cost Codes & Budget Tab (View)', description: 'Can view job budget and cost code setup' },
      { key: 'jobs.tabs.cost_codes_budget.edit', label: 'Cost Codes & Budget Tab (Edit)', description: 'Can edit cost codes and budget tab' },
      { key: 'jobs.tabs.forecasting.view', label: 'Forecasting Tab (View)', description: 'Can view job forecasting' },
      { key: 'jobs.tabs.forecasting.edit', label: 'Forecasting Tab (Edit)', description: 'Can edit job forecasting' },
      { key: 'jobs.tabs.plans.view', label: 'Plans Tab (View)', description: 'Can view plans and plan sheets' },
      { key: 'jobs.tabs.plans.edit', label: 'Plans Tab (Edit)', description: 'Can upload/delete/manage plans' },
      { key: 'jobs.tabs.rfis.view', label: 'RFIs Tab (View)', description: 'Can view RFIs' },
      { key: 'jobs.tabs.rfis.edit', label: 'RFIs Tab (Edit)', description: 'Can create/edit RFIs' },
      { key: 'jobs.tabs.billing.view', label: 'Billing Tab (View)', description: 'Can view job billing, SOV, and draws' },
      { key: 'jobs.tabs.billing.edit', label: 'Billing Tab (Edit)', description: 'Can edit SOV and draft draws' },
      { key: 'jobs.tabs.billing.approve_sov', label: 'Billing Tab (Approve SOV)', description: 'Can approve and lock schedule of values' },
      { key: 'jobs.tabs.billing.draws', label: 'Billing Tab (Manage Draws)', description: 'Can create/edit/send draws' },
      { key: 'jobs.tabs.photos.view', label: 'Photos Tab (View)', description: 'Can view job photos' },
