...
const PLACEHOLDER_CATEGORIES = [
  ...
  },
  {
    ...
    placeholders: [
      ...
      { placeholder: '{contract_start_date}', description: 'Contract start date (alias of contract date / falls back to job start date)' },
      { placeholder: '{project_start_date}', description: 'Project start date (alias of contract date / falls back to job start date)' },
  ...
  },
  {
    ...
    placeholders: [
      ...
      { placeholder: '{total_completed_stored_to_date}', description: 'Alias of total completed and stored to date' },
      { placeholder: '{total_completed_and_stored_to_date}', description: 'Alias of total completed and stored to date' },
  ...
  },
  {
    ...
    placeholders: [
      ...
      { placeholder: '{sov_retainage_stored_material}', description: 'Line item retainage attributable to stored material' },
      { placeholder: '{sov_retainage_completed_work}', description: 'Line item retainage attributable to completed work' },
    ],
  },
  {
    category: 'G703 Totals Row (Template Totals)',
    placeholders: [
      { placeholder: '{g703_total_scheduled_value}', description: 'Total scheduled value' },
      { placeholder: '{g703_total_revised_budget}', description: 'Alias: total revised budget' },
      { placeholder: '{g703_total_revised_contract}', description: 'Alias: total revised contract' },
      { placeholder: '{g703_total_previous_applications}', description: 'Total previous applications/certificates' },
      { placeholder: '{g703_total_revisions}', description: 'Alias: total previous applications (revisions column)' },
      { placeholder: '{g703_total_revision}', description: 'Alias: total previous applications (revision)' },
      { placeholder: '{g703_total_this_period}', description: 'Total this period' },
      { placeholder: '{g703_total_materials_stored}', description: 'Total materials stored' },
      { placeholder: '{g703_total_completed}', description: 'Total completed' },
      { placeholder: '{g703_total_completed_to_date}', description: 'Alias: total completed to date' },
      { placeholder: '{g703_total_completed_stored_to_date}', description: 'Alias: total completed + stored to date' },
      { placeholder: '{g703_total_completed_and_stored_to_date}', description: 'Alias: total completed + stored to date' },
      { placeholder: '{g703_total_balance_to_finish}', description: 'Total balance to finish' },
      { placeholder: '{g703_total_retainage}', description: 'Total retainage' },
      { placeholder: '{g703_total_retainage_stored_material}', description: 'Total retainage for stored material' },
      { placeholder: '{g703_total_retainage_materials_stored}', description: 'Alias: total retainage for stored material' },
      { placeholder: '{g703_total_retainage_stored}', description: 'Alias: total retainage for stored material' },
      { placeholder: '{g703_total_retainage_completed_work}', description: 'Total retainage for completed work' },
      { placeholder: '{g703_total_retainage_complete_work}', description: 'Alias: total retainage for completed work' },
      { placeholder: '{g703_total_retainage_completed}', description: 'Alias: total retainage for completed work' },
      { placeholder: '{g703_overall_percent_complete}', description: 'Overall percent complete across G703 line items' },
      { placeholder: '{g703_total_percent_complete}', description: 'Alias: overall percent complete' },
      { placeholder: '{g703_percent_complete}', description: 'Alias: overall percent complete' },
    ],
  },
];
