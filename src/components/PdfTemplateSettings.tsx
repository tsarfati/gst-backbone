...
export default function PdfTemplateSettings() {
  ...
  const [activeTemplateTab, setActiveTemplateTab] = useState<'general' | 'subcontracts'>(
    initialSection === 'subcontracts' ? 'subcontracts' : 'general'
  );
  ...
  return (
    <div className="space-y-6">
      <Tabs value={activeTemplateTab} onValueChange={(value) => setActiveTemplateTab(value as 'general' | 'subcontracts')} className="space-y-6">
        <div className="overflow-x-auto">
          <TabsList className="inline-flex h-auto min-w-full justify-start rounded-none border-b bg-transparent p-0">
            <TabsTrigger value="general" className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent">
              General PDF Templates
            </TabsTrigger>
            <TabsTrigger value="subcontracts" className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent">
        ...
        <TabsContent value="subcontracts" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Build and manage the templates used to populate generated subcontract agreements.
              </CardDescription>
            </CardHeader>
            <CardContent>
