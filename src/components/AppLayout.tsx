...
const navigationCategories = [
  ...
  },
  {
    ...
    icon: HardHat,
      ...
      items: [
        ...
        { name: "Schedule", href: "/construction/schedule", menuKey: "jobs" },
        ...
        { name: "Reports", href: "/construction/reports", menuKey: "construction-reports-view" },
      ],
    collapsible: true,
  },
  {
    ...
    items: [
      ...
      { name: "Receipt Reports", href: "/receipts/reports", menuKey: "receipt-reports-view" },
    ],
    collapsible: true,
  },
  {
    ...
    items: [
      ...
      { name: "Reports", href: "/receivables/reports", menuKey: "receivables-reports-view" },
    ],
    collapsible: true,
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Reports", href: "/employees/reports", menuKey: "employees-reports-view" },
    ],
    collapsible: true,
  },
  {
