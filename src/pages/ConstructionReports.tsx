...
export default function ConstructionReports() {
  const reports: ReportCatalogItem[] = [
    ...
    { key: "ap-aging-by-job", title: "AP Aging By Job", description: "Invoice aging report showing open AP balances by project", icon: Clock, to: "/construction/reports/ap-aging-by-job", isBuilt: true, requiredPermissions: ["construction-reports-view"] },
