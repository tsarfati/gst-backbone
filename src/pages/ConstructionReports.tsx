...
export default function ConstructionReports() {
  const reports: ReportCatalogItem[] = [
    ...
    { key: "project-tasks", title: "Project Tasks", description: "View all tasks across projects", icon: FileText, to: "/tasks/projects", isBuilt: true, requiredPermissions: ["construction-reports-view"] },
